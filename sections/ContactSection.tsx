...
const ContactSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    window.location.href = `mailto:contacto@ku-soluciones.cl?subject=${subject}&body=${body}`;
  };
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-3 font-opensans text-gray-700 dark:text-gray-300">
                <p><strong>Email:</strong> <a href="mailto:contacto@ku-soluciones.cl" className="text-pomegranate-600 dark:text-pomegranate-400 hover:underline">contacto@ku-soluciones.cl</a></p>
                <p><strong>Teléfono:</strong> <a href="tel:+56912345678" className="text-pomegranate-600 dark:text-pomegranate-400 hover:underline">+56 9 1234 5678</a></p>
                <p><strong>Dirección:</strong> Av. Digital 101, Santiago, Chile</p>
              </div>
              <div className="mt-6">
